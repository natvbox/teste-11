...
function ProtectedRoute({
  ...
  if (requireAdmin && userData.role !== "admin") return <Redirect to="/my-notifications" />;
  // USER pages: por regra, USER sempre vê inbox; ADMIN pode ver inbox apenas se receber mensagem do OWNER.
  // Para não bloquear tecnicamente o acesso, permitimos ADMIN aqui.
  if (requireUser && userData.role !== "user" && userData.role !== "admin") return <Redirect to="/dashboard" />;
          ...
          <AuthProvider>
            <Switch>
              ...
              <Route path="/subscription" component={() => (
                <ProtectedRoute component={Subscription} requireOwner />
              )} />
