...
export const notificationsRouter = router({
        ...
        const result = await db.transaction(async (tx) => {
          const inserted = await tx
            ...
            .values({
              ...
              priority: input.priority,
              createdBy: ownerId,
              // ✅ Persistir o targetType real (o enum do banco suporta admins/tenants)
  ...
  /**
   * ✅ Alias para compatibilidade com o frontend (UserNotifications.tsx)
   * Retorna a contagem de mensagens NÃO lidas na inbox.
   */
